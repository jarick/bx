...
class ConfirmRegistrationManagerSpec extends ObjectBehavior
{
	use \BX\DB\DBTrait;
	function let()
	{
	...
	{
		$this->shouldHaveType('BX\User\ConfirmRegistrationManager');
	}
	...
	function it_clear()
	{
		...
		$sql = 'SELECT * FROM tbl_confirm_registration';
